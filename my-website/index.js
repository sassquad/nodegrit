...
// establish default port number - we need to ensure localhost (or your computer's IP) is available.
...
server.listen(portnumber, function() {
    console.log("Server is running on http://10.198.118.109:"+portnumber);
});
...
function showInformation() {
    return "<!DOCTYPE html>" +
        ...
        "<body>" +
        "<h1>Information</h1>" +
        "<p>The server is running on port: "+ portnumber +
        "</p>" +
        "</body>" +
        "</html>";
}
...
// create a function call - enter doSomething() to display Hi there on the REPL console.
replServer.context.doSomething = function() {
    console.log("Hi there");
};

// define our own command within REPL, called '.sayhello'
// we type .sayhello Steve, and we'll respond with the output 'Hello, Steve'
// type .help at any time to show help.
